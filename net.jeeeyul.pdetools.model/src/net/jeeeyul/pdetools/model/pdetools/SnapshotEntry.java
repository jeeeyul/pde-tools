...
public interface SnapshotEntry extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='<%org.eclipse.emf.ecore.resource.Resource%> _eResource = this.eResource();\n<%org.eclipse.emf.common.util.URI%> _uRI = _eResource.getURI();\n<%java.lang.String%> _fileString = _uRI.toFileString();\n<%org.eclipse.core.runtime.Path%> _path = new <%org.eclipse.core.runtime.Path%>(_fileString);\n<%org.eclipse.core.runtime.IPath%> _removeLastSegments = _path.removeLastSegments(1);\n<%org.eclipse.core.runtime.IPath%> base = _removeLastSegments.setDevice(null);\n<%org.eclipse.core.runtime.IPath%> filePath = null;\nboolean _and = false;\n<%java.lang.String%> _renderedFile = this.getRenderedFile();\nboolean _notEquals = (!<%com.google.common.base.Objects%>.equal(_renderedFile, null));\nif (!_notEquals)\n{\n\t_and = false;\n} else\n{\n\t<%java.lang.String%> _renderedFile_1 = this.getRenderedFile();\n\t<%java.lang.String%> _trim = _renderedFile_1.trim();\n\tboolean _isEmpty = _trim.isEmpty();\n\tboolean _equals = (_isEmpty == false);\n\t_and = (_notEquals && _equals);\n}\nif (_and)\n{\n\t<%java.lang.String%> _renderedFile_2 = this.getRenderedFile();\n\t<%org.eclipse.core.runtime.IPath%> _append = base.append(_renderedFile_2);\n\tfilePath = _append;\n}\nelse\n{\n\t<%java.lang.String%> _originalFile = this.getOriginalFile();\n\t<%org.eclipse.core.runtime.IPath%> _append_1 = base.append(_originalFile);\n\tfilePath = _append_1;\n}\n<%java.io.File%> _file = filePath.toFile();\nreturn _file.getAbsolutePath();'"
	 * @generated
	 */
